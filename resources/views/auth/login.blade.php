    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 bg-cool-gray-700 text-white space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                    @csrf
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password" type="password"
                            class="form-input w-full bg-cool-gray-600 @error('password') border-red-500 @enderror" name="password"
                            required>
